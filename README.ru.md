...
Откройте **http://127.0.0.1:5050** в **Google Chrome** — откроется веб-интерфейс с настройками.

> **Браузер:** Используйте **Chrome** — аудио-монитор и маршрутизация через BlackHole работают корректно. В Safari монитор не работает из-за ограничений аудио-выхода браузера. Другие браузеры не тестировались.
...
>
> Введите их в **Settings** (иконка шестерёнки) или в файле `.env`.
