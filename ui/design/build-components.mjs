#!/usr/bin/env bun
/**
 * Phase 5 — rebuild Foundations + Tokens + Elements + Patterns + Components from tokens.json.
 * Usage: bun ui/design/build-components.mjs
 */
...
figma.currentPage = figma.root.children.find((p) => p.name === 'Components');
...
console.log('Foundations + Tokens + Elements + Patterns + Components rebuilt from tokens.json');
